#!/usr/bin/env node
/**
 * detect-reposts.mjs — Repost Detector for outreach-ops
 *
...
const SCAN_HISTORY_PATH = join(OUTREACH_OPS, 'data/scan-history.tsv');
...
function printSummary(clusters) {
  console.log(`\n${'='.repeat(78)}`);
  console.log('  Repost Detector — outreach-ops');
