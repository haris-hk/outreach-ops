...
const DEFAULT_PORTALS_PATH = process.env.OUTREACH_OPS_PORTALS || 'portals.yml';
...
const PROVIDERS_DIR = resolve(dirname(fileURLToPath(import.meta.url)), '..', 'providers', 'ats');
