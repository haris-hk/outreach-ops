...
// Ensures every supported CLI gets .*/skills/outreach-ops/SKILL.md even when the
...
export const CANONICAL_SKILL_PATH = '.agents/skills/outreach-ops/SKILL.md';

export const SKILL_ENTRYPOINTS = [
  {
    path: '.claude/skills/outreach-ops/SKILL.md',
    pointer: '../../../.agents/skills/outreach-ops/SKILL.md',
  },
  {
    path: '.opencode/skills/outreach-ops/SKILL.md',
    pointer: '../../../.agents/skills/outreach-ops/SKILL.md',
  },
  {
    path: '.qwen/skills/outreach-ops/SKILL.md',
    pointer: '../../../.agents/skills/outreach-ops/SKILL.md',
  },
  {
    path: '.antigravitycli/skills/outreach-ops/SKILL.md',
    pointer: '../../../.agents/skills/outreach-ops/SKILL.md',
  },
  {
    path: '.grok/skills/outreach-ops/SKILL.md',
    pointer: '../../../.agents/skills/outreach-ops/SKILL.md',
  },
];
